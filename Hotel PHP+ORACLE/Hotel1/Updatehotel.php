...
class hotel extends connect
{
	...
	{
		$sql="update hotel set name='$_POST[t2]', address='$_POST[t3]', suburb='$_POST[t4]', postcode='$_POST[t5]', state='$_POST[t6]', phoneno='$_POST[t7]',
		managerid='$_POST[t8]' where hotel_id='$_POST[t1]'";
...
if(isset($_REQUEST["b2"]))
	...
	echo"
    	<form name=f method=post action=Updatehotel.php>
		<h1>Hotel Form</h1>
