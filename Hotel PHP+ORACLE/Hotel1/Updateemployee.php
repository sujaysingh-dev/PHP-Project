...
class employee extends connect
{
	...
	{
		$sql="update employee set firstname='$_POST[t2]',lastname='$_POST[t3]',dob='$_POST[t4]',address='$_POST[t5]',suburb='$_POST[t6]',postcode='$_POST[t7]',state='$_POST[t8]',phoneno='$_POST[t9]',emailaddress='$_POST[t10]'
		 where staffid='$_POST[t1]'";
...
if(isset($_REQUEST["b2"]))
	...
	echo"
    	<form name=f method=post action=Updateemployee.php>
		<h1>Employee Form</h1>
