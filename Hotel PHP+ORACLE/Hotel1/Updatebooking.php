...
class booking extends connect
{
	...
	{
		$sql="update booking set customerid='$_POST[t2]',roomid='$_POST[t3]',bookingdate='$_POST[t4]'
                ,checkindate='$_POST[t5]',checkoutdate='$_POST[t6]',noofnights='$_POST[t7]' where bookingid='$_POST[t1]'";
...
echo"
        <form name=f method=post action=Updatebooking.php>
                <h1>Booking Form<h1>
                ...
                <input type=text name=t7 onkeypress='return allowOnlyNumbers(event,t6)' value=$ob->t7>
